...
| **T5.4** | 12-Hour Cooldown Bypass | ✅ **PASS** | Cooldown enforced to restrict child screen-time; bypassable via long-press on dashboard badge in [storybook_screen.dart](file:///d:/my-dev-knowledge-base/sitara/storybook_screen.dart#L559). |
